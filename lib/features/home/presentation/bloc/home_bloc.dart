...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  static HomeState _buildInitialState() {
    const categories = [
      ...
      Category(name: 'MCs', icon: EventraImages.cakesCategoryIcon),
      Category(name: 'DJs', icon: EventraImages.rentalCategoryIcon),
      Category(name: 'Catering', icon: EventraImages.cakesCategoryIcon),
    ];
