...
class PersonalDetailsFormBody extends StatelessWidget {
  const PersonalDetailsFormBody({super.key});
            ...
            child: IntrinsicHeight(
              child: BlocBuilder<SignupBloc, SignupState>(
                builder: (context, state) {
                  final isVendor = state.accountType == AccountType.vendor;
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      EventraGeneralTextfield(
                        label: isVendor
                            ? l10n.personalDetailsVendorFirstNameLabel
                            : l10n.firstNameLabel,
                      ...
                      EventraDatePickerTextfield(
                        label: isVendor
                            ? l10n.personalDetailsVendorDateOfBirthLabel
                            : l10n.birthdayLabel,
                        hint: isVendor
                            ? l10n.personalDetailsVendorDateOfBirthHint
                            : l10n.birthdayHint,
                        onChanged: (val) {
                          try {
                      ...
                      if (isVendor) ...[
                        24.vertSpacing,
                        EventraGeneralTextfield(
                          label: l10n.personalDetailsVendorReferralLabel,
                          hint: l10n.personalDetailsVendorReferralHint,
                          keyboardType: TextInputType.text,
                          onChanged: (val) => context.read<SignupBloc>().add(
                            SignupReferralCodeChanged(val),
                          ),
                        ),
                      ],
                      const Spacer(),
