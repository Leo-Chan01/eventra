  ...
  static ClientInboxState _buildInitialState() {
    const threads = [
      MessageThread(
        id: 'vendor-001',
        vendorName: 'Jenny',
        vendorAvatar: EventraImages.janeDoe,
        lastMessage: 'Hello, i want to make an enquiry',
      ...
      MessageThread(
        id: 'vendor-002',
        vendorName: 'Moses',
        vendorAvatar: EventraImages.johnDoeFour,
        lastMessage: 'Hello',
        lastMessageTime: 'Today',
        unreadCount: 2,
        isOnline: false,
      ...
      MessageThread(
        id: 'thread-003',
        vendorName: 'Tayo',
        vendorAvatar: EventraImages.johndoesecond,
        lastMessage: 'Send Invoice',
        lastMessageTime: 'Today',
        unreadCount: 0,
        isOnline: false,
      ),
      MessageThread(
        id: 'thread-004',
        vendorName: 'Chris',
        vendorAvatar: EventraImages.decoratorPerson,
        lastMessage: 'Send Invoice',
        lastMessageTime: 'Today',
        unreadCount: 0,
        isOnline: false,
      ...
      MessageThread(
        id: 'thread-005',
        vendorName: 'Mark',
        vendorAvatar: EventraImages.johndoethree,
        lastMessage: 'Send Invoice',
        lastMessageTime: 'Today',
        unreadCount: 0,
        isOnline: false,
